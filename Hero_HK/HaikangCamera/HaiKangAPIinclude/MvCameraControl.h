...
/************************************************************************/
/* 相机的基本指令和操作                                                 */
/* CameraRGB basic instructions and operations                             */
/************************************************************************/
/********************************************************************//**
 *  @~chinese
 *  @brief  获取SDK版本号
 ...
 *  @param  nAddress                    [IN]            Memory address to be read, which can be obtained from the CameraRGB.xml file of the device, the form xml node value of xxx_RegAddr
 ...
 *  @param  nAddress                    [IN]            Memory address to be written, which can be obtained from the CameraRGB.xml file of the device, the form xml node value of xxx_RegAddr
 ...
 *  @return Success, return #MV_OK. Failure, return error code
 *  @remarks Get network transmission information through this API, including received data size, number of lost frames. Call this API after starting image acquiring through MV_CC_StartGrabbing. This API is supported only by GigEVision CameraRGB.
************************************************************************/
 ...
 *  @~english
 *  @brief  Get the optimal Packet Size, Only support GigE CameraRGB
 *  @param  handle                      [IN]            Device handle
 ...
 *  @param  handle                      [IN]        CameraRGB Handle
 ...
 *  @param  handle                      [IN]        CameraRGB Handle
 *  @param  nValue                      [IN]        CameraRGB height value to set, note that this value must be times of nInc of pstValue returned by MV_CC_GetWidth
 ...
 *  @param  handle                  [IN]        CameraRGB Handle
 *  @param  nValue                  [IN]        CameraRGB X offset value to set
 ...
 *  @param  handle                      [IN]        CameraRGB Handle
 *  @param  nValue   [IN]        CameraRGB Y offset value to set
 ...
 *  @param  handle                      [IN]        CameraRGB Handle
 *  @param  fValue                      [IN]        CameraRGB frame rate to set
 ...
 *  @return Success, return #MV_OK, and get the structure of the corresponding parameters. Failure, return error code
 *                                     - float           fCurValue;      // CameraRGB current gain
 ...
 *  @return Success, return #MV_OK, and get the structure of the corresponding parameters. Failure, return error code
 *                                     - float           fCurValue;      // CameraRGB current exposure time
